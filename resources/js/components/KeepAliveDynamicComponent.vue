<template>
	<section>
		<h1><code>keep-alive</code> with Dynamic Components</h1>
	...
	template: `
		<div class="posts-tab">
			<ul class="posts-sidebar">
				<li v-for="post in posts" :key="post.id" :class="{ selected: post === selectedPost }"
					@click="selectedPost = post">{{ post.title }}</li>
			</ul>
